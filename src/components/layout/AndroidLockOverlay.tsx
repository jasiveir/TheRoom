...
import { Smartphone, Download, Monitor, ShieldAlert, Sparkles, CheckCircle2 } from 'lucide-react';
import { setAndroidBypass, isAndroidLockActive } from '../../lib/deviceUtils';
...
export const AndroidLockOverlay: React.FC<AndroidLockOverlayProps> = ({
  ...
  const handleBypass = () => {
    setAndroidBypass(true);
    onBypass();
  };

  return (
    <div className="fixed inset-0 z-[100] bg-black text-white flex flex-col items-center justify-center p-6 overflow-y-auto">
      ...
      <div className="w-full max-w-md bg-zinc-950 border-2 border-zinc-800 rounded-3xl p-6 sm:p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] text-center relative z-10 my-auto">
        ...
        <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-green-500/10 border border-green-500/30 rounded-full text-green-400 text-xs font-mono font-bold uppercase tracking-wider mb-3">
          ...
          <span>Android Mobile Detected</span>
        </div>
        ...
        <p className="text-xs text-zinc-400 leading-relaxed mb-6">
          To access high-speed real-time messaging, camera QR code friend scanner, and background glitch ringing notifications, please install the official Android APK app.
        </p>
        ...
        <div className="bg-zinc-900 border-2 border-zinc-800 rounded-2xl p-4 text-left space-y-2.5 mb-6 shadow-[3px_3px_0px_0px_rgba(0,0,0,1)]">
          <div className="flex items-center gap-2.5 text-xs text-zinc-300">
            ...
            <span>Instant Camera QR Code Friend Scanning</span>
          </div>
          <div className="flex items-center gap-2.5 text-xs text-zinc-300">
            <CheckCircle2 className="w-4 h-4 text-green-400 shrink-0" />
