  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-black p-4 sm:p-6 overflow-y-auto">
      <div className="max-w-3xl mx-auto w-full space-y-6">
        ...
        <div className="p-4 bg-zinc-900 rounded-2xl text-white shadow-md border border-zinc-800 flex items-center justify-between">
          <div>
        ...
        <div className="bg-zinc-900 rounded-2xl border border-zinc-800 p-4 sm:p-6 space-y-4 shadow-xl">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 pb-2 border-b border-zinc-800">
            ...
            <button
              ...
              className="w-full sm:w-auto justify-center px-3 py-1.5 bg-purple-950 hover:bg-purple-900 border border-purple-800 text-purple-300 rounded-xl text-xs font-bold flex items-center gap-1.5 transition-all shadow-sm cursor-pointer shrink-0"
            >
